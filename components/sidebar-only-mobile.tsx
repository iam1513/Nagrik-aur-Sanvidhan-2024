...
export const SidebarMobileOnly = ({ className }: Props) => {
    ...
    return (
        <div
            className={cn(
                "flex h-full lg:w-[256px] lg:fixed left-0 top-0 px-4 border-r-2 flex-col bg-[#1C1F2B] ",
                className
            )}
        >
            {/* <Link href="/learn">
        <div className="pt-8 pl-4 pb-7 flex items-center gap-x-3">
          ...
          <h1 className="text-2xl font-extrabold text-green-600 tracking-wide">
            ...
            <div className="flex flex-col gap-y-2 flex-1 mt-16">
